        ...
        btn_getVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!my_phone.equals("")) {
                    ...
                    mAction.getVerification(my_phone, new ActionCallbackListener<String>() {
        ...
        APPLY.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (edit_verification.getText().toString().equals("")) {
                    ...
                    //手机验证码验证
                    mAction.getverify(my_phone, my_verification, new ActionCallbackListener<Boolean>() {
                        @Override
                        public void onSuccess(Boolean data) {
                            if (data) {
                                mAction.update_major_attachment(files,
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.LL_apply_specialty:
                intent.setClass(this, ApplySpecialtyActivity.class);
